...
plt.plot(x,y20, color='gainsboro')
plt.plot(x,y22, color='gainsboro')
plt.plot(x,y24, color='gainsboro')
plt.plot(x,y25, color='gainsboro')
plt.plot(x,y26, color='gainsboro')
plt.plot(x,y27, color='gainsboro')
plt.plot(x,y4, color='r', label='Biochemistry, Genetics and Molecular Biology',linewidth=2.5)
plt.plot(x,y19, color='gold', label='Neuroscience',linewidth=2.5)
plt.plot(x,y21, color='chartreuse', label='Pharmacology, Toxicology and Pharmaceutics',linewidth=2.5)
plt.plot(x,y15, color='saddlebrown', label='Immunology and Microbiology',linewidth=2.5)
plt.plot(x,y2, color='m', label='Agricultural and Biological Sciences',linewidth=2.5)
plt.plot(x,y23, color='dodgerblue', label='Psychology',linewidth=2.5)
...
plt.xticks(size = 15)
plt.yticks(size = 15)
plt.ylabel('reference to Medicine',fontsize='xx-large')
plt.savefig('beiyin.png')
plt.show()
